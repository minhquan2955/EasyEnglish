...
export default function Schedule() {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      const url =
        user?.role === "admin"
          ? `/admin/schedules/${editingSession._id}`
          : `/schedules/${editingSession._id}`;
          ...
          <div className="flex bg-black p-1 rounded-full border border-gray-800">
            <button
              ...
              style={{
                borderRadius: "9999px",
                backgroundColor:
                  activeTab === "list" ? "#0070d1" : "transparent",
            ...
            <button
              ...
              style={{
                borderRadius: "9999px",
                backgroundColor:
                  activeTab === "calendar" ? "#0070d1" : "transparent",
            ...
            <>
                    ...
                    {summaries.length === 0 ? (
                      ...
                      summaries.map((s) => (
                        ...
                        >
                          ...
                          <td className="py-4">
                            <span className="text-ps-blue font-medium">
                              {s.scheduled}
                            </span>
                          </td>
                          <td className="py-4">
                          ...
                          <td className="py-4 text-gray-400">
                            {s.firstDate
                              ? new Date(s.firstDate).toLocaleDateString(
                                  "vi-VN",
                                )
                              : "-"}
                          </td>
              ...
              <div className="mt-8 p-6 bg-black border border-gray-800 rounded-[8px]">
                ...
                <p className="text-sm text-gray-400 mb-4">
                  Chọn một lớp bên dưới → hệ thống sẽ tự động tạo tất cả buổi
                  học dựa trên thông tin ngày học, ngày bắt đầu/kết thúc của
                  lớp.
                </p>
          ...
          >
            ...
            <p className="text-sm text-gray-400 mb-6">
              ...
              <span className="text-white">
                {new Date(editingSession.date).toLocaleDateString("vi-VN", {
                  weekday: "long",
                  day: "2-digit",
                  month: "2-digit",
                  year: "numeric",
              ...
              <div className="pt-2">
                ...
                >
                  {editLoading ? (
                    ...
                    <>
                      <PencilSimple size={18} weight="bold" /> Cập nhật buổi học
                    </>
                  )}
                </button>
              </div>
