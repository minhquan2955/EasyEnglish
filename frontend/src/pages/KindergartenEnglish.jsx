...
import kindergartensrc from "../assets/kindergarten.png";
    ...
    <main>
        ...
        <div className="w-full max-w-[1280px] mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-[18px] text-body-light max-w-2xl mx-auto">
              Lộ trình tiếng Anh cá nhân hóa cho mẫu giáo — đồng hành để con cảm
              thấy thuộc về, tự tin nói, thỏa trí tò mò, hình thành thói quen
              học tập, cam kết đạt Pre-A1 chuẩn Cambridge.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-6 text-[18px] text-on-dark-mute leading-relaxed">
                <p>
                  Ở lứa tuổi mẫu giáo, mỗi đứa trẻ là một mầm non với những nhịp
                  điệu phát triển khác nhau. Điều con cần nhất lúc này là nơi
                  mọi nỗ lực nhỏ bé đều được nhìn thấy, thấu hiểu, đồng hành.
                </p>
                <p>
                  Khi con được nói, được sai, được khích lệ & cảm thấy an toàn
                  cảm xúc, hạt mầm của sự tự tin, tò mò, bền bỉ bắt đầu nảy nở
                  cùng năng lực ngôn ngữ…
                </p>
              </div>
            </div>
            <div className="w-full lg:w-1/2">
              <div className="grid grid-cols-2 gap-4">
                ...
                />
                <img
                  src="https://images.unsplash.com/photo-1473649085228-583485e6e4d7?q=80&w=2064&auto=format&fit=crop"
        ...
        <div className="w-full max-w-[1280px] mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {[
              {
                num: "1",
                title: "Con cảm thấy thuộc về",
                desc: "Con cảm thấy an toàn và thuộc về tập thể. Việc học bắt đầu phát triển khi con sử dụng ngôn ngữ như một sở thích.",
              },
              {
                num: "2",
                title: "Con thỏa trí tò mò",
                desc: "Con khám phá thế giới và đặt câu hỏi với phản xạ ngôn ngữ và diễn đạt tự nhiên, phát âm chuẩn.",
              },
              {
                num: "3",
                title: "Con tự tin",
                desc: "Con dám nói, dám sai và được khích lệ và đó là nền tảng cho sự tự tin lâu dài.",
              },
              {
                num: "4",
                title: "Con bền bỉ, không bỏ cuộc",
                desc: "7 thói quen học tập được tích hợp có chủ đích, giúp con chủ động học tập, biết đối mặt khó khăn.",
              },
            ].map((step, i) => (
              <div
                key={i}
              ...
              >
                ...
                <h3 className="text-[20px] font-display font-bold text-ps-blue mb-4">
                  {step.title}
                </h3>
        ...
        <div className="w-full max-w-[1280px] mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[18px] text-body-light mt-6 max-w-2xl mx-auto">
              Tạm biệt tất cả những băn khoăn: con đã sẵn sàng chưa?; con có vui
              học không?... vì hành trình này "may đo" cho chính con:
            </p>
          </div>
      ...
      <section className="bg-canvas-dark text-on-dark w-full py-24">
        <div className="w-full max-w-[1280px] mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-[14px] font-bold uppercase tracking-widest text-ps-blue mb-2 block">
              Để rồi, kết quả ngọt ngào nhất chính là...
            </span>
            <h2 className="display-lg text-ps-blue uppercase mb-2">
              Nhìn thấy con tự tin
            </h2>
            <p className="text-[24px] font-display font-light">
              Mở cánh cửa tương lai theo cách của mình
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-surface-dark-card p-10 rounded-md relative">
              ...
              <p className="text-[16px] text-on-dark-mute leading-relaxed mb-8 relative z-10">
                Bé nhà mình vốn rất nhát, gặp người lạ là trốn sau lưng mẹ.
                Nhưng từ khi học tại đây, mình bất ngờ khi thấy con chủ động
                chào hỏi và líu lo hát tiếng Anh cả ngày. Con không hề sợ sai,
                vì con biết ở lớp, các thầy cô luôn cổ vũ và tôn trọng mọi ý
                tưởng của con.
              </p>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[14px] text-ps-blue">
                    Bé 5 tuổi &middot; 2 năm đồng hành
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-surface-dark-card p-10 rounded-md relative">
              ...
              <p className="text-[16px] text-on-dark-mute leading-relaxed mb-8 relative z-10">
                Điều tôi lo nhất khi con vào lớp 1 là con không tập trung được.
                Nhưng qua lộ trình "đo ni đóng giày", tôi thấy con hình thành
                được thói quen tự học rất tốt. Con nhận biết âm, đọc chữ cái tự
                nhiên và đặc biệt là cực kỳ tự tin khi bước vào môi trường mới.
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-ps-blue text-canvas-light flex items-center justify-center font-bold text-xl">
                  P
                ...
                <div>
                  ...
                  <p className="text-[14px] text-ps-blue">
                    Phụ huynh học sinh &middot; 2 năm đồng hành
                  </p>
                </div>
              </div>
            </div>
